    ...
    <div className="navbar fixed top-0 left-0 w-full z-50">
      <div className="navbar-end w-full">
        ...
        <div className="dropdown dropdown-end">
          ...
          <ul tabIndex={-1} 
            className="menu menu-md dropdown-content bg-base-100 rounded-box mt-0 w-52 p-2 shadow-sm" 
            onClick={() => document.activeElement?.blur()}>
              ...
              {role === "Admin" && (
                  <li><Link href="/admin"><span className="solar--user-id-broken"></span>Admit Panel</Link></li>
                )
              }
          </ul>
        </div>
